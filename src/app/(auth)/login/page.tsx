    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className={cn("w-full max-w-md space-y-6 relative", shake && "animate-[shake_0.4s_ease-in-out]")}>
        ...
        <div className="glass rounded-2xl p-8 space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-card px-3 text-muted-foreground">или войдите с email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4" noValidate>
            ...
            <div className="space-y-1.5">
              ...
              />
              {errors.email && <p className="text-xs text-red-400 flex items-center gap-1"><span>⚠</span>{errors.email}</p>}
            </div>
        ...
        <p className="text-center text-sm text-muted-foreground">
          Нет аккаунта?{" "}
          <Link href="/register" className="text-primary hover:underline font-medium">Зарегистрируйтесь</Link>
        </p>
      </div>
    </div>
  );
